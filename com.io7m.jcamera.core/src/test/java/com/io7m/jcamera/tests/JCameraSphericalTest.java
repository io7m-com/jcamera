...
public final class JCameraSphericalTest
{
  ...
  private static
  @NonNull
  ContextRelative newContextRelative6dp()
  {
  ...
  public void testSnapshotEquality()
  {
    ...
    Assert.assertEquals((long) snap_0.hashCode(), (long) snap_0.hashCode());
    Assert.assertNotEquals((long) snap_0.hashCode(), (long) snap_1.hashCode());
