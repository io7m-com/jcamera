...
public abstract class JCameraSphericalLinearIntegratorContract
{
  ...
  public final void testMovingBackward_0()
  {
    ...
    {
      final Vector3D expected = Vector3D.of(0.0, 0.0, 18.0);
  ...
  public final void testMovingBackward_1()
  {
    ...
    {
      final Vector3D expected = Vector3D.of(0.0, 0.0, 13.0);
      final Vector3D actual = c.cameraGetPosition();
      JCameraSphericalLinearIntegratorContract.dumpVector(
        "position expected",
        expected);
  ...
  public final void testMovingDown_0()
  {
    ...
    {
      final Vector3D expected = Vector3D.of(0.0, -10.0, 8.0);
      final Vector3D actual = c.cameraGetPosition();
      JCameraSphericalLinearIntegratorContract.dumpVector(
        "position expected",
        expected);
  ...
  public final void testMovingDown_1()
  {
    ...
    {
      final Vector3D expected = Vector3D.of(0.0, -5.0, 8.0);
      final Vector3D actual = c.cameraGetPosition();
      JCameraSphericalLinearIntegratorContract.dumpVector(
        "position expected",
        expected);
  ...
  public final void testMovingDrag_0()
  {
    ...
    {
      final Vector3D expected = Vector3D.of(0.0, 0.0, 7.0);
      final Vector3D actual = c.cameraGetPosition();
      JCameraSphericalLinearIntegratorContract.dumpVector(
        "position expected",
        expected);
  ...
  public final void testMovingForward_0()
  {
    ...
    {
      final Vector3D expected = Vector3D.of(0.0, 0.0, -2.0);
      final Vector3D actual = c.cameraGetPosition();
      JCameraSphericalLinearIntegratorContract.dumpVector(
        "position expected",
        expected);
  ...
  public final void testMovingForward_1()
  {
    ...
    {
      final Vector3D expected = Vector3D.of(0.0, 0.0, 3.0);
      final Vector3D actual = c.cameraGetPosition();
      JCameraSphericalLinearIntegratorContract.dumpVector(
        "position expected",
        expected);
  ...
  public final void testMovingLeft_0()
  {
    ...
    {
      final Vector3D expected = Vector3D.of(-10.0, 0.0, 8.0);
      final Vector3D actual = c.cameraGetPosition();
      JCameraSphericalLinearIntegratorContract.dumpVector(
        "position expected",
        expected);
  ...
  public final void testMovingLeft_1()
  {
    ...
    {
      final Vector3D expected = Vector3D.of(-5.0, 0.0, 8.0);
      final Vector3D actual = c.cameraGetPosition();
      JCameraSphericalLinearIntegratorContract.dumpVector(
        "position expected",
        expected);
