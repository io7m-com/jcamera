...
@SuppressWarnings("static-method") public final class JCameraSignallingClampTest
{
  @Test public void testClampMaximum()
  {
  ...
  @Test public void testClampMinimum()
  {
    final JCameraSignallingClamp sc = new JCameraSignallingClamp();
