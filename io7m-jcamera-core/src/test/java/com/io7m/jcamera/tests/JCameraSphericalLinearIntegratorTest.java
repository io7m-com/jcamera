...
public final class JCameraSphericalLinearIntegratorTest extends
  JCameraSphericalLinearIntegratorContract
{
  @Override @NonNull JCameraSphericalLinearIntegratorType newIntegrator(
    final @NonNull JCameraSphericalType c,
    final @NonNull JCameraSphericalInputType i)
  {
    return JCameraSphericalLinearIntegrator.newIntegrator(c, i);
  }
