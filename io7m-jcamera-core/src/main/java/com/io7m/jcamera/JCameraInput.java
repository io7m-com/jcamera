...
@EqualityReference public final class JCameraInput
{
  /**
   * @return A new input
   */

  public static JCameraInput newInput()
  {
    return new JCameraInput();
  }
  ...
  private float   rotate_horizontal_factor;
  private float   rotate_vertical;
  private float   rotate_vertical_factor;
  private boolean up;

  private JCameraInput()
  {
  ...
  @Override public String toString()
  {
    ...
    b.append("[JCameraInput backward=");
